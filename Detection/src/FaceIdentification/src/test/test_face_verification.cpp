...
#if 1
std::string DATA_DIR = "E:/SeetaFaceEngine-master/FaceIdentification/data/";
std::string MODEL_DIR = "E:/SeetaFaceEngine-master/FaceIdentification/model/";
#endif // 1
...
int main(int argc, char* argv[]) {
  ...
  seeta::FaceDetection detector("E:/SeetaFaceEngine-master/FaceDetection/model/seeta_fd_frontal_v1.0.bin");
  ...
  seeta::FaceAlignment point_detector("E:/SeetaFaceEngine-master/FaceAlignment/model/seeta_fa_v1.1.bin");
